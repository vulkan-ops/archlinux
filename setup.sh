...
sed -i -e 's/GRUB_CMDLINE_LINUX_DEFAULT="loglevel=3"/GRUB_CMDLINE_LINUX_DEFAULT="loglevel=3 acpi_backlight=vendor acpi_osi=Linux mitigations=off"/g' /etc/default/grub
